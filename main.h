...
uint8_t main_FM_text[19] = 	   {'m','t','x','t','.','t','x','t','=','"','0','0','0','.','0','"',255,255,255};
uint8_t main_BT_text[4][19] = {{'m','t','x','t','.','t','x','t','=','"','N','O','D','e','v','"',255,255,255},
							   {'m','t','x','t','.','t','x','t','=','"','C','o','n','n',' ','"',255,255,255},
							   {'m','t','x','t','.','t','x','t','=','"','P','L','A','Y',' ','"',255,255,255},
							   {'m','t','x','t','.','t','x','t','=','"','P','A','U','S','E','"',255,255,255}};

uint8_t main_AUX_text[14] =  {'m','t','x','t','.','t','x','t','=','"','"',255,255,255};
...
uint8_t main_NO_USB_text[19] = {'m','t','x','t','.','t','x','t','=','"','N','O','U','S','B','"',255,255,255};
uint8_t main_USB_text[19] = {'m','t','x','t','.','t','x','t','=','"',' ',' ',' ',' ',' ','"',255,255,255};
uint8_t txt_text[52] = {'t','x','t','0','.','t','x','t','=','"',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ','"',255,255,255,\
                        't','x','t','1','.','t','x','t','=','"',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ','"',255,255,255};
uint8_t no_txt_text[28] = {'t','x','t','0','.','t','x','t','=','"','"',255,255,255,\
                           't','x','t','1','.','t','x','t','=','"','"',255,255,255};
...
uint8_t pul_text[25] = {'p','u','l','.','t','x','t','=','"','_','_','_','_','H','z',' ',' ',' ',' ',' ',' ','"',255,255,255};
...
uint8_t  sub_cut_off_freq[5][4] = {{' ','5','5',' '},\
                                   {' ','8','5',' '},\
                                   {'1','2','0',' '},\
                                   {'1','6','0',' '},\
                                   {'O','F','F',' '}};
